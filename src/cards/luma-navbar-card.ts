...
export class LumaNavbarCard extends LitElement implements LovelaceCard{
  ...
  static styles=css`
    ...
    @media(max-width:767px){.media-dock{left:12px;right:12px;bottom:88px;width:auto;min-height:62px;border-radius:18px}.art{width:44px;height:44px;border-radius:13px}.title{font-size:12px}}
  `;
