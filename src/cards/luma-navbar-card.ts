...
export class LumaNavbarCard extends LitElement implements LovelaceCard{
  ...
  private cycleMedia(event:Event,count:number){event.stopPropagation();this.selectedMedia=(this.selectedMedia+1)%count}
