...
import { localizedMap, localized } from "../localize";
...
const labelsEn:Record<string,string>={open:"Open",closed:"Closed",opening:"Opening",closing:"Closing",unavailable:"Unavailable"};const labelsHu:Record<string,string>={open:"Nyitva",closed:"Zárva",opening:"Nyílik",closing:"Záródik",unavailable:"Nem elérhető"};
