...
export class LumaHistoryCard extends LitElement implements LovelaceCard {
  ...
  static styles = [lumaTokens, css`
    ...
    @media(max-width:600px){ha-card{min-height:240px;padding:14px 10px 10px}.top{align-items:flex-start}.legend{gap:5px}.chart svg{height:190px}.tooltip{transform:none;left:8px}}
  `];
