...
interface Config { type:string; entity:string; state_entity?:string; name?:string; subtitle?:string; icon?:string; color?:string; active_color?:string; active_states?:string[]; state_map?:Record<string,string>; action_label?:string; display_as?:"light"|"media_player"|"switch"; artwork?:boolean; artwork_entity?:string; embedded_details?:boolean; compact?:boolean; wrap_value?:boolean; tap_action?:LumaAction; hold_action?:LumaAction }
