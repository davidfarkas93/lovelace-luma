...
export class LumaTimelineCard extends LitElement implements LovelaceCard {
  ...
  static styles = [lumaTokens, css`
    ...
    @media(max-width:720px){ha-card{padding:14px}.timeline{grid-template-columns:1fr}.event{grid-template-columns:105px minmax(0,1fr)}.snapshot{width:105px}.dialog{padding:10px}.player{border-radius:18px}}
  `];
